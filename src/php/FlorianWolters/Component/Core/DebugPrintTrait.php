...
trait DebugPrintTrait
{
     ...
     * "textually represents" the object using the trait {@link
     * DebugPrintTrait}. The result should be a concise but informative
     * representation that is easy for a person to read.
     *
     * The {@link __toString} method for trait {@link DebugPrintTrait} returns a
     ...
     *
     * The method {@link __toString} implements the *Debug Print Method*
